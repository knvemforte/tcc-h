...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public User signUpUser(String name, String email, String password, String cpf) {
    ...
    @Override
    public User updateUser(Integer userId, String name, String password, String cpf) {
